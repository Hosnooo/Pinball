...
Game::Game() : leftFlipper(LEFT, Vector2D{ FLIPPER1_POSITION_X, FLIPPER_POSITION_Y }, FLIPPER_LENGTH, 30.0f, FLIPPER_MAJOR_RADIUS, FLIPPER_MINOR_RADIUS),
            ...
            leftFloor(LEFT, GAME_WIDTH/2.0f, sf::Vector2f(FLIPPER1_POSITION_X, FLIPPER_POSITION_Y)),
            rightFloor(RIGHT, GAME_WIDTH / 2.0f, sf::Vector2f(FLIPPER2_POSITION_X, FLIPPER_POSITION_Y)),
